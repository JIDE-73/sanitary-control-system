    ...
    <MainLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight">Emitir Certificado Sanitario</h1>
            <p className="text-muted-foreground">Complete los datos para emitir un nuevo certificado</p>
          </div>
        </div>
